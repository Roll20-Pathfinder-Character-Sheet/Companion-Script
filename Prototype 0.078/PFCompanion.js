...
var PFCompanion = PFCompanion || (function() {
    ...
    var version = 'Prototype 0.078',
        sheetVersion = 1.5,
        lastUpdate = 1494379259,
        schemaVersion = 0.078,
        defaults = {
            css: {
                button: {
        ...
        parser = async () =>{
            ...
            parseSection = async () =>{
                ...
                if(!_.isEmpty(statBlock)){
                    ...
                    _.each(keys,(k)=>{
                        switch(true){
                            ...
                            case k==='token':
                                ...
                                break;
                            case k==='description':
                                description=accrue[k]+(description ? '<br><br>'+description : '');
                                break;
                            ...
                            case k==='tactics':
                                if(description.match(/<br>TACTICS<br>/)){
                                    description = description.replace('ECOLOGY',accrue[k]+'<br><br>ECOLOGY');
                                }else{
                            ...
                            case k==='content_compendium':
                                ...
                                if(separated){
                                    ...
                                    description = separated[2] ? (description ? description+'<br><br>' : '')+separated[2] : description;
                                }
                                break;
                            default:
                    ...
                    iChar.set('gmnotes',(description ? description.replace(/\n/g,'<br>') : ''));
