...
var PFCompanion = PFCompanion || (function() {
    ...
    var version = 'Prototype 0.079',
        sheetVersion = 1.51,
        lastUpdate = 1494396129,
        schemaVersion = 0.079,
        defaults = {
            css: {
                button: {
    ...
    statblockHandler = async function(text,characters,who){
        ...
        var block,iChar,blockSection,attributes,
            convert = {
                ...
                'statistics':[null,'str_compendium','dex_compendium','con_compendium','int_compendium','wis_compendium','cha_compendium','bab_compendium','cmb_compendium','cmd_compendium','npc-feats-text','skills_compendium','racial_mods_compendium','languages','SQ_compendium','add to description'],
