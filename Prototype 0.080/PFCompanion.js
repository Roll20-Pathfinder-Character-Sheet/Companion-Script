    ...
    statblockHandler = async function(text,characters,who){
        ...
        var block,iChar,blockSection,attributes,
            convert = {
                ...
                'statistics':[null,'str_compendium','dex_compendium','con_compendium','int_compendium','wis_compendium','cha_compendium','bab_compendium','cmb_compendium','cmd_compendium','npc-feats-text','skills_compendium','racial_mods_compendium','languages','SQ_compendium','add to description','gear1','gear2'],
        ...
        parser = async () =>{
            ...
            parseSection = async () =>{
                ...
                if(block){
                    section = block[0].match(/^(defense|offense|statistics|tactics|ecology|special abilities|gear)\n/i);
                    ...
                    keyWorker = async () =>{
                        ...
                        switch(true){
                            case (k==='gear'||k==='gear 1'||k==='gear 2'):
                                var gearType = accrue[k].match(/^(GEAR\n+|Gear|Other Gear|Combat Gear)\s+/) ? accrue[k].match(/^(GEAR\n+|Gear|Other Gear|Combat Gear)\s+/)[0] : undefined;
